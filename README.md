...
<p align="center">
  <img src="docs/widget-preview.png" alt="Widget Preview" width="530">
</p>
...
<p>Важно: проверьте содержимое .env, особенно:</p>
...
⚙️ Админ-панель	http://localhost:8080/admin/settings	Управление настройками
...
protected function schedule(Schedule $schedule)
{
    ...
    $schedule->command('cbr:fetch')->hourly();
    
    // Или в рабочее время по будням
    $schedule->command('cbr:fetch')
        ->weekdays()
        ->between('10:00', '17:00')
        ->everyThirtyMinutes();
}
Затем добавьте системный cron для запуска планировщика:
